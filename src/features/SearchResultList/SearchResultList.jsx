...
function SearchResultList() {
    ...
    const clickDetailHandler = (item, setDetail) => {
        setDetail({ address: item.address, doctor: item.doctor, specialised: item.treatable_symptoms });
    };
        ...
        return (<>
            {detail &&
                <InformationForClinic>
                    <InfoWrapper>
                        <img src='https://images.unsplash.com/photo-1651008376811-b90baee60c1f?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8ZG9jdG9yfGVufDB8fDB8fHww' width={200} height={200} />
                ...
                {MOCK_DATA.map((item) => (
                    <SearchResultListBox key={item.id}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            ...
                            <Button onClick={() => clickButtonHandler(item, setDetail)} type="button" className="buttonForInfo" >Clinic Info</Button>
                        </div>
                        ...
                        <TextForList>walk in available • reservation recommended</TextForList>
